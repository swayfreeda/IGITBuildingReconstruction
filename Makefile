...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Nov 17 22:20:33 2014
...
SOURCES       = main.cpp \
		...
		graph.cpp \
		alpha_expansion.cpp \
		maxflow.cpp moc_sw_glviewer.cpp \
...
alpha_expansion.o: alpha_expansion.cpp sw_alpha_expansion.h \
		energy.h \
		graph.h \
		block.h \
		sw_dataType.h \
		sw_functions.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o alpha_expansion.o alpha_expansion.cpp
